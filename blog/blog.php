...
?>
    <?php foreach($result as $blog){ ?>
        <div class="card">
            <figure class="card__img">
                <a href="blogView.php?blogID=<?=$blog['blogID']?>"><img src="../assets/blog/<?=$blog['blogImgFile']?>" alt="<?=$blog['blogTitle']?>"></a>
            </figure>
            <div class="card__title">
            ...
            <div class="card__info">
                <a href="blogView.php?blogID=<?=$blog['blogID']?>" class="more">더보기</a>
            </div>
        </div>
    <?php } ?>
                    </div>
